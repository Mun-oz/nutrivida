...
// 2. LÓGICA DE INYECCIÓN PARA CATÁLOGO
    ...
    if (tbodyCatalogo) {
        catalogoServicios.forEach((servicio, index) => {
            ...
            fila.innerHTML = `
                ...
                <td style="display: flex; gap: 0.5rem;">
                    <button class="btn-small btn-save" type="button" onclick="verCatalogo(${index})">Ver Detalles</button>
...
// Función global para el catálogo
window.verCatalogo = function(index) {
    const catalogoServicios = [
        { codigo: "CN001", nombre: "Primera consulta nutricional", precio: 35000 },
        { codigo: "CN002", nombre: "Control nutricional (seguimiento)", precio: 25000 },
        { codigo: "CN003", nombre: "Control nutricional quincenal", precio: 22000 },
    ...
    const servicioSeleccionado = catalogoServicios[index];
    localStorage.setItem('catalogoActivo', JSON.stringify(servicioSeleccionado));
    window.location.href = 'mostrar_catalogo.html';
};
